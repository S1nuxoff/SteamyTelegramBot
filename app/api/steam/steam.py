...
import re
import urllib.parse
from app.utils.steam import clear_url
...
# ----------------------------------------------------------------------------------------------------------------------
# async def fetch_html(appid, market_hash_name, period, currency_id):
...
#
#     dates, prices, sales = await extract_trading_data(html_data)
...
#         "sales_at_avg_price": sales_at_avg_price,
